...
function PatientsPage() {
    ...
    // Nouveaux états pour les notifications améliorées
            ...
            if (alertes.length > 0) {
                ...
                if (prochainsRdvs.length === 1) {
                    ...
                    setNotificationData({
                        ...
                        reason: patient.diagnosis || "Consultation"
                    });
                    setNotificationAction({
                    ...
                    const details = prochainsRdvs.map((p)=>{
                        ...
                        return `• ${p.name} - ${rdvDate.toLocaleDateString("fr-FR")} à ${rdvDate.toLocaleTimeString("fr-FR", {
                            hour: "2-digit",
                            minute: "2-digit"
                        })}`;
                    }).join("\n");
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        ...
        // Décommenter pour tester la notification
        /*
    setTimeout(() => {
      setNotification("Test de notification rendez-vous");
      setNotificationType("appointment");
      setNotificationData({
...
_s(PatientsPage, "oddIV7gJiZquI+AFHhFfT1H9Kwo=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
...
//# sourceMappingURL=app_429311f4._.js.map